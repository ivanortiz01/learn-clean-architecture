...
using Study.CleanArchitecture.Application.Features.LeaveType.Commands.DeleteLeaveType;
using Study.CleanArchitecture.Application.Features.LeaveType.Commands.UpdateLeaveType;
...
public class LeaveTypesController : ControllerBase
{
    ...
    [HttpGet]
    public Task<List<LeaveTypeDto>> GetAsync() =>
        _mediator.Send(new GetLeaveTypesQuery());
